...
export const SignUpForm: FunctionComponent<{withGoogle: boolean}> = ({
  ...
  const formSchema = z.object({
    firstName: z.string(),
    lastName: z.string(),
    email: withGoogle ? z.string().optional() : z.string().email({
      message: "Invalid email address.",
    }),
    password: withGoogle ? z.string().optional(): z.string().min(9, {
      message: "Password must be at least 9 characters long."
    }),
    confirmPassword: withGoogle ? z.string().optional() : z.string().min(9, {
      message: "Password must be at least 9 characters long."
    }),
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type={withGoogle ? 'text' : 'password'} placeholder="Password" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type={withGoogle ? 'text' : 'password'} placeholder="Re-enter your password" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input type="Enter your phone number" placeholder="Phone number" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
